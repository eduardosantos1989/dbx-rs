...
/// User-defined type metadata flags returned in describe information.
#[allow(missing_docs)]
pub mod uds_flags {
    pub const IS_JSON: u32 = 0x0000_0100;
    pub const IS_OSON: u32 = 0x0000_0800;
}
...
pub mod charset {
    ...
    pub const UTF8: u16 = AL32UTF8;
    pub const UTF16: u16 = AL16UTF16;
}
...
pub mod ccap_value {
    ...
    pub const FIELD_VERSION_18_1_EXT_1: u8 = 11;
